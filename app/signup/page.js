...
const SignUp = () => {
  ...
  return (
    <section className='relative flex flex-col justify-center items-center pt-24 min-h-screen min-w-screen' style={{
      background: `linear-gradient(134.56deg, rgba(155, 126, 234, 0.2) 10.8%, rgba(255, 127, 127, 0.2) 88.78%)`,
    }}>
      <Navbar navText={false} />
      <form onSubmit={handleLoginSubmit} className='bg-accent p-5 rounded-lg w-[90%] sm:w-[70%] md:w-[50%] lg:w-[45%] xl:w-[40%] 2xl:w-[30%] bg-[#ffffff66]'>
        <h4 className='text-2xl mb-3'>Get more out of your files with our search tool – sign up today</h4>
        <div className='flex items-center justify-center mt-7'>
          <div className='relative w-full border border-primary rounded-lg px-3 py-2.5 mr-2 bg-[#ffffff66] z-0' >
            <label htmlFor="" className='absolute -top-2.5 left-2 px-1 text-primary z-10 bg-[#f9f1f6]'>First name</label>
            <div className='flex items-center w-full'>
              <Image src={UserIcon} width={20} height={20} alt='mail icons' />
              <input type="text" placeholder='Rakibul' className='w-full outline-none bg-[#ffffff66] ml-2 text-primary' />
            </div>
          </div>
          <div className='relative w-full border border-primary rounded-lg px-3 py-2.5 ml-2 bg-[#ffffff66] z-0' >
            <label htmlFor="" className='absolute -top-2.5 left-2 px-1 text-primary z-10 bg-[#f9f1f6]'>Last name</label>
            <div className='flex items-center w-full'>
              <Image src={UserIcon} width={20} height={20} alt='mail icons' />
              <input type="text" placeholder='Islam' className='w-full outline-none bg-[#ffffff66] ml-2 text-primary' />
            </div>
          </div>
        </div>

        <div className='relative mt-7 w-full border border-primary rounded-lg px-3 py-2.5 bg-[#ffffff66] z-0' >
          <label htmlFor="" className='absolute -top-2.5 left-2 px-1 text-primary z-10 bg-[#f9f1f6]'>User name</label>
          <div className='flex items-center w-full'>
            <Image src={UserIcon} width={20} height={20} alt='mail icons' />
            <input type="text" placeholder='rakibul-wdp' className='w-full outline-none bg-[#ffffff66] ml-2 text-primary' />
          </div>
        </div>
        <span className='text-sm'>username (must start with a letter) - (letters, numbers, and underscores)</span>

        <div className='relative mt-5 w-full border border-primary rounded-lg px-3 py-2.5 bg-[#ffffff66] z-0' >
        ...
        <div className='relative mt-7 w-full border border-primary rounded-lg px-3 py-2.5 bg-[#ffffff66]' >
        ...
        <div className='relative mt-5 mb-7 w-full border border-primary rounded-lg px-3 py-2.5 bg-[#ffffff66] z-0' >
          <label htmlFor="" className='absolute -top-2.5 left-2 px-1 text-primary z-10 bg-[#f9f1f6]'>Referral code (optional)</label>
          <div className='flex items-center w-full'>
            <Image src={GiftIcon} width={20} height={20} alt='mail icons' />
            <input type="text" placeholder='Ux123' className='w-full outline-none bg-[#ffffff66] ml-2 text-primary' />
          </div>
        </div>
